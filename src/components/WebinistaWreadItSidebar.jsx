...
const WebinistaWreadItSidebar = () => {
    ...
    const requestGeneration = () => {
      ...
      apiFetch( requestObj ).then( ( response ) => {
          if (response && Object.hasOwn(response, 'url') ) {
            ...
            throw new Error("Something is wrong. The server response didn't include a URL.");
          }
      });
    }
    ...
    const copyIt = () => {
      if( !Object.hasOwn(urlRef, 'current') ) {
          throw new Error("I can't find the text to copy. Save your post and reload the page.");
      }
