...
namespace Webinista\WreadIt\Aws3\Aws\Sts\RegionalEndpoints;

use Webinista\WreadIt\Aws3\Aws\AbstractConfigurationProvider;
use Webinista\WreadIt\Aws3\Aws\CacheInterface;
use Webinista\WreadIt\Aws3\Aws\ConfigurationProviderInterface;
use Webinista\WreadIt\Aws3\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \Webinista\WreadIt\Aws3\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
