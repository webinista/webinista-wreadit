...
use Webinista\WreadIt\Aws3\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(AwsClientInterface $client, CommandInterface $cmd)
    {
        ...
        $request = \Webinista\WreadIt\Aws3\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointProviderV2) {
