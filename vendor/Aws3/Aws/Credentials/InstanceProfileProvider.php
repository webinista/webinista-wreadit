...
namespace Webinista\WreadIt\Aws3\Aws\Credentials;

use Webinista\WreadIt\Aws3\Aws\Configuration\ConfigurationResolver;
use Webinista\WreadIt\Aws3\Aws\Exception\CredentialsException;
use Webinista\WreadIt\Aws3\Aws\Exception\InvalidJsonException;
use Webinista\WreadIt\Aws3\Aws\Sdk;
use Webinista\WreadIt\Aws3\GuzzleHttp\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = $config['client'] ?? \Webinista\WreadIt\Aws3\Aws\default_http_handler();
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \Webinista\WreadIt\Aws3\Aws\default_user_agent();
    ...
    {
        $isImdsV1Disabled = \Webinista\WreadIt\Aws3\Aws\boolean_value($this->ec2MetadataV1Disabled) ?? \Webinista\WreadIt\Aws3\Aws\boolean_value(ConfigurationResolver::resolve(self::CFG_EC2_METADATA_V1_DISABLED, self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED, 'bool', $this->config)) ?? self::DEFAULT_AWS_EC2_METADATA_V1_DISABLED;
