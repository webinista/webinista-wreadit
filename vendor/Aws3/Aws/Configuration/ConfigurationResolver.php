...
namespace Webinista\WreadIt\Aws3\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool' && !is_null($convertedValue = \Webinista\WreadIt\Aws3\Aws\boolean_value($value))) {
    ...
    private static function retrieveValueFromIniSubsection($data, $profile, $filename, $expectedType, $options)
    {
        ...
        $services_section = \Webinista\WreadIt\Aws3\Aws\parse_ini_section_with_subsections($filename, "services {$data[$profile]['services']}");
