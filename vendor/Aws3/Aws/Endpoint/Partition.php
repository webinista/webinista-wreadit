...
namespace Webinista\WreadIt\Aws3\Aws\Endpoint;

use ArrayAccess;
use Webinista\WreadIt\Aws3\Aws\HasDataTrait;
use Webinista\WreadIt\Aws3\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use Webinista\WreadIt\Aws3\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
