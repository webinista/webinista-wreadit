...
use Webinista\WreadIt\Aws3\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \Webinista\WreadIt\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \Webinista\WreadIt\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
