...
use Webinista\WreadIt\Aws3\Aws\Auth\AuthSelectionMiddleware;
use Webinista\WreadIt\Aws3\Aws\Auth\AuthSchemeResolverInterface;
use Webinista\WreadIt\Aws3\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointProviderV2;
use Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointV2Middleware;
use Webinista\WreadIt\Aws3\Aws\Exception\AwsException;
use Webinista\WreadIt\Aws3\Aws\Signature\SignatureProvider;
use Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Uri;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function parseClass()
    {
        ...
        return [strtolower($service), "Webinista\\WreadIt\\Aws3\\Aws\\{$service}\\Exception\\{$service}Exception"];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \Webinista\WreadIt\Aws3\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \Webinista\WreadIt\Aws3\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
