...
namespace Webinista\WreadIt\Aws3\Aws\S3;

use Webinista\WreadIt\Aws3\Aws\Api\ApiProvider;
use Webinista\WreadIt\Aws3\Aws\Api\DocModel;
use Webinista\WreadIt\Aws3\Aws\Api\Service;
use Webinista\WreadIt\Aws3\Aws\AwsClient;
use Webinista\WreadIt\Aws3\Aws\CacheInterface;
use Webinista\WreadIt\Aws3\Aws\ClientResolver;
use Webinista\WreadIt\Aws3\Aws\Command;
...
use Webinista\WreadIt\Aws3\Aws\HandlerList;
use Webinista\WreadIt\Aws3\Aws\Identity\S3\S3ExpressIdentityProvider;
use Webinista\WreadIt\Aws3\Aws\InputValidationMiddleware;
use Webinista\WreadIt\Aws3\Aws\Middleware;
use Webinista\WreadIt\Aws3\Aws\ResultInterface;
use Webinista\WreadIt\Aws3\Aws\Retry\QuotaManager;
use Webinista\WreadIt\Aws3\Aws\RetryMiddleware;
use Webinista\WreadIt\Aws3\Aws\RetryMiddlewareV2;
use Webinista\WreadIt\Aws3\Aws\S3\Parser\GetBucketLocationResultMutator;
use Webinista\WreadIt\Aws3\Aws\S3\Parser\S3Parser;
use Webinista\WreadIt\Aws3\Aws\S3\Parser\ValidateResponseChecksumResultMutator;
use Webinista\WreadIt\Aws3\Aws\S3\RegionalEndpoint\ConfigurationProvider;
use Webinista\WreadIt\Aws3\Aws\S3\UseArnRegion\Configuration;
use Webinista\WreadIt\Aws3\Aws\S3\UseArnRegion\ConfigurationInterface;
use Webinista\WreadIt\Aws3\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        $request = \Webinista\WreadIt\Aws3\Aws\serialize($command);
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \Webinista\WreadIt\Aws3\Aws\serialize($command)->getUri();
    }
    /**
    ...
    {
        if ($value) {
            $config = \Webinista\WreadIt\Aws3\Aws\Retry\ConfigurationProvider::unwrap($value);
