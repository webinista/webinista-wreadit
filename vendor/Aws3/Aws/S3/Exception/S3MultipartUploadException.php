...
namespace Webinista\WreadIt\Aws3\Aws\S3\Exception;

use Webinista\WreadIt\Aws3\Aws\CommandInterface;
use Webinista\WreadIt\Aws3\Aws\Exception\AwsException;
use Webinista\WreadIt\Aws3\Aws\Multipart\UploadState;
class S3MultipartUploadException extends \Webinista\WreadIt\Aws3\Aws\Exception\MultipartUploadException
{
