...
use Webinista\WreadIt\Aws3\Aws\LruArrayCache;
...
use Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Stream;
use Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \Webinista\WreadIt\Aws3\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use ($filterFn) {
