...
namespace Webinista\WreadIt\Aws3\Aws\Api;

use Webinista\WreadIt\Aws3\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \Webinista\WreadIt\Aws3\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \Webinista\WreadIt\Aws3\Aws\load_compiled_json($path);
