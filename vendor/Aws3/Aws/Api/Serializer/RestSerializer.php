...
namespace Webinista\WreadIt\Aws3\Aws\Api\Serializer;

use Webinista\WreadIt\Aws3\Aws\Api\ListShape;
use Webinista\WreadIt\Aws3\Aws\Api\MapShape;
use Webinista\WreadIt\Aws3\Aws\Api\Service;
use Webinista\WreadIt\Aws3\Aws\Api\Operation;
use Webinista\WreadIt\Aws3\Aws\Api\Shape;
use Webinista\WreadIt\Aws3\Aws\Api\StructureShape;
use Webinista\WreadIt\Aws3\Aws\Api\TimestampShape;
use Webinista\WreadIt\Aws3\Aws\CommandInterface;
use Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointV2SerializerTrait;
use Webinista\WreadIt\Aws3\Aws\EndpointV2\Ruleset\RulesetEndpoint;
...
use Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\UriResolver;
