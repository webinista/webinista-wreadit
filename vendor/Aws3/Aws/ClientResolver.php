...
use Webinista\WreadIt\Aws3\Aws\Api\ApiProvider;
use Webinista\WreadIt\Aws3\Aws\Api\Service;
use Webinista\WreadIt\Aws3\Aws\Api\Validator;
use Webinista\WreadIt\Aws3\Aws\Auth\AuthResolver;
use Webinista\WreadIt\Aws3\Aws\Auth\AuthSchemeResolver;
use Webinista\WreadIt\Aws3\Aws\Auth\AuthSchemeResolverInterface;
use Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\Configuration;
...
use Webinista\WreadIt\Aws3\Aws\DefaultsMode\ConfigurationInterface as ConfigModeInterface;
use Webinista\WreadIt\Aws3\Aws\DefaultsMode\ConfigurationProvider as ConfigModeProvider;
use Webinista\WreadIt\Aws3\Aws\Endpoint\EndpointProvider;
use Webinista\WreadIt\Aws3\Aws\Endpoint\PartitionEndpointProvider;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseDualstackEndpoint\Configuration as UseDualStackEndpointConfiguration;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationInterface as UseDualStackEndpointConfigurationInterface;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseDualstackEndpoint\ConfigurationProvider as UseDualStackConfigProvider;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseFipsEndpoint\Configuration as UseFipsEndpointConfiguration;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationInterface as UseFipsEndpointConfigurationInterface;
use Webinista\WreadIt\Aws3\Aws\Endpoint\UseFipsEndpoint\ConfigurationProvider as UseFipsConfigProvider;
use Webinista\WreadIt\Aws3\Aws\EndpointDiscovery\ConfigurationInterface;
use Webinista\WreadIt\Aws3\Aws\EndpointDiscovery\ConfigurationProvider;
use Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointDefinitionProvider;
use Webinista\WreadIt\Aws3\Aws\Exception\AwsException;
use Webinista\WreadIt\Aws3\Aws\Exception\InvalidRegionException;
use Webinista\WreadIt\Aws3\Aws\Retry\ConfigurationInterface as RetryConfigInterface;
use Webinista\WreadIt\Aws3\Aws\Retry\ConfigurationProvider as RetryConfigProvider;
use Webinista\WreadIt\Aws3\Aws\Signature\SignatureProvider;
use Webinista\WreadIt\Aws3\Aws\Token\Token;
use Webinista\WreadIt\Aws3\Aws\Token\TokenInterface;
use Webinista\WreadIt\Aws3\Aws\Token\BedrockTokenProvider;
use Webinista\WreadIt\Aws3\Aws\Token\TokenProvider;
use Webinista\WreadIt\Aws3\GuzzleHttp\Promise\PromiseInterface;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \Webinista\WreadIt\Aws3\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointProviderV2) {
            ...
            $args['region'] = \Webinista\WreadIt\Aws3\Aws\strip_fips_pseudo_regions($args['region']);
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName) && self::isValidApiVersion($serviceName, $apiVersion)) {
            ...
            return new \Webinista\WreadIt\Aws3\Aws\EndpointV2\EndpointProviderV2($ruleset, EndpointDefinitionProvider::getPartitions());
        }
        $options = self::getEndpointProviderOptions($args);
    ...
    public static function _apply_suppress_php_deprecation_warning($value, &$args)
    {
        if ($value) {
            ...
            $args['suppress_php_deprecation_warning'] = \Webinista\WreadIt\Aws3\Aws\boolean_value(getenv("AWS_SUPPRESS_PHP_DEPRECATION_WARNING"));
        } elseif (!empty($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \Webinista\WreadIt\Aws3\Aws\boolean_value($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        } elseif (!empty($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \Webinista\WreadIt\Aws3\Aws\boolean_value($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        }
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \Webinista\WreadIt\Aws3\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private static function isValidService($service)
    {
        ...
        $services = \Webinista\WreadIt\Aws3\Aws\manifest();
