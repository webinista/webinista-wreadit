...
namespace Webinista\WreadIt\Aws3\GuzzleHttp\Exception;

use Webinista\WreadIt\Aws3\GuzzleHttp\BodySummarizer;
use Webinista\WreadIt\Aws3\GuzzleHttp\BodySummarizerInterface;
use Webinista\WreadIt\Aws3\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
