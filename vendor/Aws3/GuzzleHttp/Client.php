...
use Webinista\WreadIt\Aws3\GuzzleHttp\Cookie\CookieJar;
use Webinista\WreadIt\Aws3\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \Webinista\WreadIt\Aws3\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
