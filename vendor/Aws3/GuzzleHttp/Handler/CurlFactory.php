...
namespace Webinista\WreadIt\Aws3\GuzzleHttp\Handler;
...
use Webinista\WreadIt\Aws3\GuzzleHttp\Promise as P;
use Webinista\WreadIt\Aws3\GuzzleHttp\Promise\FulfilledPromise;
use Webinista\WreadIt\Aws3\GuzzleHttp\Promise\PromiseInterface;
use Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\LazyOpenStream;
...
use Webinista\WreadIt\Aws3\Psr\Http\Message\UriInterface;
/**
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx): PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri): string
    {
        ...
        $redactedUriString = \Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Webinista\WreadIt\Aws3\GuzzleHttp\Psr7\Utils::streamFor($sink);
